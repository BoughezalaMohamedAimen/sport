...
urlpatterns = [
    ...
    path('seance/anuller/<int:id>',AnullerSeance,name='suprimmer_seance_clients'),
    ...
    path('abonement/delete/<int:id>',DeleteClientAbonement.as_view(),name='delete_abonnement'),
]
